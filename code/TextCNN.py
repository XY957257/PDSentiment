...
def build_vocab(file_path, tokenizer, max_size, min_freq):#    tokenizer = lambda x: [y for y in x]
    vocab_dic = {}
    this_dataset = {}
    dataset_path = "/home/hadoop0/sparkwork3/weibo-sent-analyse/datasets/weibo_senti_100k"
...
if __name__ == '__main__':
    ...
    def fun(model):#按钮点击的函数
        f = open('result.csv', mode='w+', encoding='utf-8-sig', newline='')
